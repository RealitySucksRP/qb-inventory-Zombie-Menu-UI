# Zombie/APCode UI — v2.6.3 Cash Authority / Display Hotfix

**Development baseline:** `2.6.3-rs-zombie-cash-authority`  
**Live-confirmed:** No
...
- Zombie/APCode visual design and drop confirmation dialog.
- Physical cash/marked money behavior, AP backend, HUD bridge, expiry/freshness stacking, weapon attachments, legacy give callback, and `rs-incidentlink` integration.
- All v2.6.1 floor-drop duplication, ghost-item reconciliation, request-lock, refund, and bounded entity-wait fixes.
- All v2.6.2 cash bridge work that was already functioning.
...
server/commands.lua
CHANGELOG_RS_ZOMBIE_v2.6.1.md
CHANGELOG_RS_ZOMBIE_v2.6.2.md
CHANGELOG_RS_ZOMBIE_v2.6.3.md
```
